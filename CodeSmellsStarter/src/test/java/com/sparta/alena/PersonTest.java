...
public class PersonTest
{
    ...
    {
        var subject = new Person("Cathy", "French", new Address(10, "Ma", "Ba"));
        subject.setAge(22);
    ...
    @Test
    @DisplayName("GetAddress string returns correct address")
    public void getAddress(){
        var subject = new Person("Cathy", "French", new Address(10, "Ma", "Ba"));
        var result = subject.getAddressString();
        Assertions.assertEquals("Address: 10 Ma, Ba", result);
    }
}